...
client.on("ready", async => {
  {
    ...
    ai = {
      ...
      ping: [
        ...
        "I'm just a robot I don't do much",
        "That's me",
        "Yes?",
        "What!?",
        "my english bad sorry"
      ...
      deadchat: [
        "You can always talk to me, Im always online, just ask me basic questions like: How are you or Whats your favorite color",
        "oof",
        ":deadchat:",
        "Then just make it active",
        "@everyone get active ;/",
        "my english bad sorry"
      ],
      oh: [
      ...
      fku: [
        "No u",
        "shut the fuck up",
        "shut the fuck up dirty hoe",
        "shut ur fucking mouth tiny dick sucking hoe",
        "my english bad sorry"
      ],
      ...
      thot: [
        "Twitch thot",
        "u talking about Alinity?",
        "Ur mom?",
        "My grandma?",
        "Your neighbor?",
        "wait who?",
        "Did you seriously just say that, im gonna copy srike you now",
        "my english bad sorry"
      ],
      xd: [
        "Eks dee",
      ...
      ass: [
        "Suck it",
        "My ass is a little brown please come and help clean it (I prefer with your tounge)",
        "my ass is on the front",
        "my ass will be your toy tonight",
        "my english bad sorry"
      ],
      ...
      mem: [
        ...
        "If eu blocks memes then i'm gonna block the eu",
        "dank memes",
        "my english bad sorry",
        "Didn't funny not laugh"
      ],
    ...
    client.on("message", message => {
      ...
      for (var i in blacklisteduser) {
        if (message.author.id === blacklisteduser[i].toLowerCase()) {
          console.error(
            message.author.username + " is a blacklisted user" + "\n"
          );
          return;
        }
      }
      for (var i in blacklistedchannel) {
        if (channelId === blacklistedchannel[i].toLowerCase()) {
          console.error(
            guildName + " | " + channelName + " is a blacklisted channel" + "\n"
          );
          return;
        }
      }
      for (var i in blacklistedguild) {
      ...
      if (
        message.content.toLowerCase().includes(process.env.PREFIX + "words")
      ) {
      ...
      if (message.isMentioned(client.user)) {
        message.channel
          .send(ai.ping[Math.floor(Math.random() * ai.ping.length)])
          .catch(err => message.channel.send("peng"));
      ...
      setTimeout(() => {
        ...
        if (message.content.toLowerCase().includes("same")) {
          message.channel
            .send(ai.same[Math.floor(Math.random() * ai.same.length)])
            .catch(err => message.channel.send("Nah not the same"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("favorite color")) {
          message.channel
            .send(ai.color[Math.floor(Math.random() * ai.color.length)])
            .catch(err => message.channel.send("Brown like my poopoo"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("dead chat")) {
          message.channel
            .send(ai.deadchat[Math.floor(Math.random() * ai.deadchat.length)])
            .catch(err =>
              message.channel.send(
                "You can always talk to me, Im always online"
              )
            );
          console.info(message.author.tag + ": " + message.content);
          return;
        ...
        if (message.content.toLowerCase().includes("oh")) {
          message.channel
            .send(ai.oh[Math.floor(Math.random() * ai.oh.length)])
            .catch(err => message.channel.send("yeah"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("who are you")) {
          message.channel
            .send(ai.who[Math.floor(Math.random() * ai.who.length)])
            .catch(err =>
              message.channel.send(
                "I am a AI auto responding self bot, you can talk to me and I will give cool responses!"
              )
            );
          console.info(message.author.tag + ": " + message.content);
          return;
        ...
        if (message.content.toLowerCase().includes("do it")) {
          message.channel
            .send(ai.cmon[Math.floor(Math.random() * ai.cmon.length)])
            .catch(err => message.channel.send("YES DO IT!"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("wtf")) {
          message.channel
            .send(ai.wtf[Math.floor(Math.random() * ai.wtf.length)])
            .catch(err => message.channel.send("wut da fook!"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("lmao")) {
          message.channel
            .send(ai.ayy[Math.floor(Math.random() * ai.ayy.length)])
            .catch(err => message.channel.send("Oi le moo!"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("bruh")) {
          message.channel
            .send(ai.bruh[Math.floor(Math.random() * ai.bruh.length)])
            .catch(err => message.channel.send("BR|_| |_|!"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("omg")) {
          message.channel
            .send(ai.omg[Math.floor(Math.random() * ai.omg.length)])
            .catch(err => message.channel.send("oh my big tiddy goth gf"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("smh")) {
          message.channel
            .send(ai.smh[Math.floor(Math.random() * ai.smh.length)])
            .catch(err => message.channel.send("BR|_| |_|!"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("lol")) {
          message.channel
            .send(ai.lol[Math.floor(Math.random() * ai.lol.length)])
            .catch(err => message.channel.send("Lawl"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("haha")) {
          message.channel
            .send(ai.haha[Math.floor(Math.random() * ai.haha.length)])
            .catch(err => message.channel.send("lol"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("fuck you")) {
          message.channel
            .send(ai.fku[Math.floor(Math.random() * ai.fku.length)])
            .catch(err => message.channel.send("oh yes fuck me hard daddy"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("fortnite")) {
          message.channel
            .send(ai.fn[Math.floor(Math.random() * ai.fn.length)])
            .catch(err =>
              message.channel.send("fortnite has the big giant gay in my ass")
            );
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("pubg")) {
          message.channel
            .send(ai.pg[Math.floor(Math.random() * ai.pg.length)])
            .catch(err =>
              message.channel.send("pubg has the big giant gay in my ass")
            );
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("hoe")) {
          message.channel
            .send(ai.hoe[Math.floor(Math.random() * ai.hoe.length)])
            .catch(err => message.channel.send("Wooden hoe"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("thot")) {
          message.channel
            .send(ai.thot[Math.floor(Math.random() * ai.thot.length)])
            .catch(err =>
              message.channel.send(
                "Did you seriously just say that, im gonna copy srike you now"
              )
        ...
        if (message.content.toLowerCase().includes("xd")) {
          message.channel
            .send(ai.xd[Math.floor(Math.random() * ai.xd.length)])
            .catch(err =>
              message.channel.send(
                "Did you seriously just say that, im gonna copy srike you now"
              )
        ...
        if (message.content.toLowerCase().includes("ass")) {
          message.channel
            .send(ai.ass[Math.floor(Math.random() * ai.ass.length)])
            .catch(err =>
              message.channel.send("Ass is short for my booty hole")
            );
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("pls")) {
          message.channel
            .send(ai.pls[Math.floor(Math.random() * ai.pls.length)])
            .catch(err => message.channel.send("Please fix my errors"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("oof")) {
          message.channel
            .send(ai.oof[Math.floor(Math.random() * ai.oof.length)])
            .catch(err => message.channel.send("Ouef a error occured"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("robot")) {
          message.channel
            .send(ai.bot[Math.floor(Math.random() * ai.bot.length)])
            .catch(err => message.channel.send("I'm not a robot"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("yeet")) {
          message.channel
            .send(ai.yeet[Math.floor(Math.random() * ai.yeet.length)])
            .catch(err => message.channel.send("Yeet error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("wat")) {
          message.channel
            .send(ai.wat[Math.floor(Math.random() * ai.wat.length)])
            .catch(err => message.channel.send("Wat I got a error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("weeb")) {
          message.channel
            .send(ai.weeb[Math.floor(Math.random() * ai.weeb.length)])
            .catch(err => message.channel.send("3rr0r"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("gay")) {
          message.channel
            .send(ai.gay[Math.floor(Math.random() * ai.gay.length)])
            .catch(err => message.channel.send("Errors are gay"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("lit")) {
          message.channel
            .send(ai.lit[Math.floor(Math.random() * ai.lit.length)])
            .catch(err => message.channel.send("Errors are lit"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("dab")) {
          message.channel
            .send(ai.dab[Math.floor(Math.random() * ai.dab.length)])
            .catch(err => message.channel.send("Dab on em errors"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("rip")) {
          message.channel
            .send(ai.rip[Math.floor(Math.random() * ai.rip.length)])
            .catch(err => message.channel.send("Rip an error has occured"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("ffs")) {
          message.channel
            .send(ai.ffs[Math.floor(Math.random() * ai.ffs.length)])
            .catch(err => message.channel.send("Ffs a error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("ok")) {
          message.channel
            .send(ai.ok[Math.floor(Math.random() * ai.ok.length)])
            .catch(err => message.channel.send("Ok an error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("no")) {
          message.channel
            .send(ai.no[Math.floor(Math.random() * ai.no.length)])
            .catch(err => message.channel.send("No an error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("yes")) {
          message.channel
            .send(ai.yes[Math.floor(Math.random() * ai.yes.length)])
            .catch(err => message.channel.send("No an error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("stfu")) {
          message.channel
            .send(ai.stfu[Math.floor(Math.random() * ai.stfu.length)])
            .catch(err => message.channel.send("Stfu error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("why")) {
          message.channel
            .send(ai.why[Math.floor(Math.random() * ai.why.length)])
            .catch(err => message.channel.send("Why do errors exist"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("nice")) {
          message.channel
            .send(ai.nice[Math.floor(Math.random() * ai.nice.length)])
            .catch(err => message.channel.send("Nice error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("ikr")) {
          message.channel
            .send(ai.ikr[Math.floor(Math.random() * ai.ikr.length)])
            .catch(err => message.channel.send("Ikr errors"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("yay")) {
          message.channel
            .send(ai.yay[Math.floor(Math.random() * ai.yay.length)])
            .catch(err => message.channel.send("Yay error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("thicc")) {
          message.channel
            .send(ai.thicc[Math.floor(Math.random() * ai.thicc.length)])
            .catch(err => message.channel.send("Thicc errors"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("good")) {
          message.channel
            .send(ai.good[Math.floor(Math.random() * ai.good.length)])
            .catch(err => message.channel.send("Errors aren't good"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("bad")) {
          message.channel
            .send(ai.bad[Math.floor(Math.random() * ai.bad.length)])
            .catch(err => message.channel.send("Errors are bad"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("wow")) {
          message.channel
            .send(ai.wow[Math.floor(Math.random() * ai.wow.length)])
            .catch(err => message.channel.send("Woah a error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("meme")) {
          message.channel
            .send(ai.mem[Math.floor(Math.random() * ai.mem.length)])
            .catch(err => message.channel.send("Memes are error"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("night")) {
          message.channel
            .send(ai.night[Math.floor(Math.random() * ai.night.length)])
            .catch(err => message.channel.send("Nighty"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        if (message.content.toLowerCase().includes("morning")) {
          message.channel
            .send(ai.morning[Math.floor(Math.random() * ai.morning.length)])
            .catch(err => message.channel.send("Mornin"));
          console.info(message.author.tag + ": " + message.content);
          return;
        }
        ...
        for (var i in ai.hello) {
          if (
            message.content.toLowerCase().startsWith(ai.hello[i].toLowerCase())
          )
            hello = true;
        }
        if (hello) {
          setTimeout(() => {
            message.channel
              .send(ai.hello[Math.floor(Math.random() * ai.hello.length)])
              .catch(err => message.channel.send("hello"));
            console.info(message.author.tag + ": " + message.content);
          }, 1000);
        }
        ...
        let hru = false;
        for (var i in ai.hru) {
          if (message.content.toLowerCase().includes(ai.hru[i].toLowerCase()))
            hru = true;
        }
        if (hru) {
          setTimeout(() => {
            message.channel
              .send(ai.hrua[Math.floor(Math.random() * ai.hrua.length)])
              .catch(err => message.channel.send("I'm having some issues"));
            console.info(message.author.tag + ": " + message.content);
          }, 1000);
          return;
        }
        ...
        for (var i in ai.welcome) {
          if (
            message.content.toLowerCase().includes(ai.welcome[i].toLowerCase())
          )
            welc = true;
        }
        if (welc) {
        ...
        if (vcon == 0) {
          ...
          console.info(
            message.author.username +
              " made me join a voice channel in: " +
              guildName +
              "\n"
          );
          message.channel.send(
            "<@" + message.author.id + ">" + " made me join a voice channel"
          );
        } else {
          vcon = 0;
          channel.leave();
          console.info(
            message.author.username +
              " made me leave the voice channel in: " +
              guildName +
              "\n"
          );
          message.channel.send(
            "<@" + message.author.id + ">" + " made me leave a voice channel"
          );
        }
      }
    });
